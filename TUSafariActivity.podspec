Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/a2/TUSafariActivity"
  ...
  s.source       = { :git => "https://github.com/a2/TUSafariActivity.git", :tag => s.version.to_s }
  s.platform     = :ios, '6.0'
  s.source_files = 'TUSafariActivity/*.{h,m}'
  s.resource_bundles = { 'TUSafariActivity' => ['TUSafariActivity/*.png', 'TUSafariActivity/*.lproj'] }
  s.requires_arc = true
end
